namespace time_in_the_cavern
{
    ...
    static class Ui
    {
        ...
        public static void DisplayGameWon(TimeSpan time)
        {
            Console.ForegroundColor = narrativeTextColor;
            Console.WriteLine("\n\n");
            ...
            Console.ForegroundColor = descriptiveTextColor;
            DisplayTimePlayed(time);
            Environment.Exit(0);
            
        }

        public static void DisplayTimePlayed(TimeSpan time)
        {
            Console.WriteLine($"Time Played: {time.Hours}H {time.Minutes}M {time.Seconds}S");
        }

        public static void DisplayGameLost(TimeSpan time)
        {
            Console.ForegroundColor = narrativeTextColor;
            Console.WriteLine("\n\n");
    ...
    static class GameManager
    {
        ...
        public static void Run()
        {
            ...
            if (playerWonEvent)
            {
                Ui.DisplayGameWon(totalTime);
            }
            else
            {
                Ui.DisplayGameLost(totalTime);   
            }
        }
